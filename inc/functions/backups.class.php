...
trait Backups {
    ...
    public function backup($manual = false) {
        ...
        if ($zip->open($backupFile, ZipArchive::CREATE) === TRUE) {
            ...
            if (!$manual) {$this->updateCronStatus('System','Scheduled Backup', 'success', "Backup Successful");}
            ...
            if (!$manual) {$this->updateCronStatus('System','Scheduled Backup', 'error', "Backup Failed");}
