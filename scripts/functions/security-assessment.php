...
function generateSecurityReport($APIKey,$StartDateTime,$EndDateTime,$Realm) {
        ...
        if (isset($_POST['APIKey']) AND isset($_POST['StartDateTime']) AND isset($_POST['EndDateTime']) AND isset($_POST['Realm'])) {
            ...
            if ($UserInfo) {
                ...
                $mapping = $extractor->extractStringsAndCreateMappingFile(
                    ...
                    $FilesDir.'/reports/report-'.$Rand.'-extracted.pptx'
                );
    
                // Extract Powerpoint Template Zip
                extractZip($FilesDir.'/reports/report-'.$Rand.'-extracted.pptx',$FilesDir.'/reports/report-'.$Rand);
                ...
                $TopThreatFeedsSS = IOFactory::load($FilesDir.'/reports/report-'.$Rand.'/ppt/embeddings/Microsoft_Excel_Worksheet.xlsx');
                $RowNo = 2;
                ...
                $TopThreatFeedsW->save($FilesDir.'/reports/report-'.$Rand.'/ppt/embeddings/Microsoft_Excel_Worksheet.xlsx');
                ...
                $TopDetectedPropertiesSS = IOFactory::load($FilesDir.'/reports/report-'.$Rand.'/ppt/embeddings/Microsoft_Excel_Worksheet1.xlsx');
                $RowNo = 2;
                ...
                $TopDetectedPropertiesW->save($FilesDir.'/reports/report-'.$Rand.'/ppt/embeddings/Microsoft_Excel_Worksheet1.xlsx');
                ...
                $ContentFiltrationSS = IOFactory::load($FilesDir.'/reports/report-'.$Rand.'/ppt/embeddings/Microsoft_Excel_Worksheet2.xlsx');
                $RowNo = 2;
                ...
                $ContentFiltrationW->save($FilesDir.'/reports/report-'.$Rand.'/ppt/embeddings/Microsoft_Excel_Worksheet2.xlsx');
                ...
                $InsightDistributionSS = IOFactory::load($FilesDir.'/reports/report-'.$Rand.'/ppt/embeddings/Microsoft_Excel_Worksheet3.xlsx');
                $RowNo = 2;
                ...
                $InsightDistributionW->save($FilesDir.'/reports/report-'.$Rand.'/ppt/embeddings/Microsoft_Excel_Worksheet3.xlsx');
                ...
                $LookalikeThreatCountsSS = IOFactory::load($FilesDir.'/reports/report-'.$Rand.'/ppt/embeddings/Microsoft_Excel_Worksheet4.xlsx');
                ...
                $LookalikeThreatCountsW->save($FilesDir.'/reports/report-'.$Rand.'/ppt/embeddings/Microsoft_Excel_Worksheet4.xlsx');
                //
    
                // Rebuild Powerpoint Template Zip
                compressZip($FilesDir.'/reports/report-'.$Rand.'-extracted.pptx',$FilesDir.'/reports/report-'.$Rand);
    
                // Cleanup Extracted Zip
                rmdirRecursive($FilesDir.'/reports/report-'.$Rand);
                ...
                $injector->injectMappingAndCreateNewFile(
                    $mapping,
                    $FilesDir.'/reports/report-'.$Rand.'-extracted.pptx',
                    $FilesDir.'/reports/report-'.$Rand.'.pptx'
                );
    
                // Cleanup
                unlink($FilesDir.'/reports/report-'.$Rand.'-extracted.pptx');
